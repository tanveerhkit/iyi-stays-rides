...
export default function Home() {
  ...
  const [confirmedRide, setConfirmedRide] = useState<{ ride: typeof rideOptions[number]; rideType: string; pickup: string; dropoff: string } | null>(null);
